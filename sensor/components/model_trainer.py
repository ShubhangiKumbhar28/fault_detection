...
class ModelTrainer:
    ...
    def initiate_model_trainer(self,)->artifact_entity.ModelTrainerArtifact:
        ...
        try:
           ...
           logging.info(f"checking if model is underfitting or not")
           if f1_test_score < self.model_trainer_config.expected_score:
               raise Exception("Model is not good as it is not able to give expected accuracy:\
                                {self.model_trainer_config.expected_score}: Model actual score is {self.f1_test_score}")
